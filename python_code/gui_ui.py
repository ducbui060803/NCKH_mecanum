...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Camera.setGeometry(QtCore.QRect(3, 3, 640, 480))
        ...
        self.Camera_label.setGeometry(QtCore.QRect(650, 10, 100, 12))
        font = QtGui.QFont()
        ...
        self.splitter.setGeometry(QtCore.QRect(650, 30, 100, 210))
        ...
        self.comboBox.setGeometry(QtCore.QRect(650, 250, 100, 20))
        ...
        groupBox.setGeometry(QtCore.QRect(755, 30, 250, 200))
        ...
        # Data show Section
        self.Aruco_Pose= QtWidgets.QLabel(self.centralwidget)
        self.Aruco_Pose.setGeometry(QtCore.QRect(650, 300, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        self.Aruco_Pose.setFont(font)
        self.Aruco_Pose.setObjectName("Aruco_Pose")

        self.EKF_predict = QtWidgets.QLabel(self.centralwidget)
        self.EKF_predict.setGeometry(QtCore.QRect(820, 300, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.x_aruco.setGeometry(QtCore.QRect(650, 330, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.x_predict.setGeometry(QtCore.QRect(820, 330, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.y_aruco.setGeometry(QtCore.QRect(650, 360, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.y_predict.setGeometry(QtCore.QRect(820, 360, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.yaw_aruco.setGeometry(QtCore.QRect(650, 390, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        self.yaw_predict.setGeometry(QtCore.QRect(820, 390, 100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        ...
        font.setPointSize(10)
        font.setWeight(75)
        self.x_aruco_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.x_aruco_txt.setGeometry(QtCore.QRect(730, 330, 50, 20))
        self.x_aruco_txt.setObjectName("x_predict_txt")
        self.x_aruco_txt.setReadOnly(True)   # không cho user sửa
        self.x_predict_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.x_predict_txt.setGeometry(QtCore.QRect(930, 330, 50, 20))
        self.x_predict_txt.setObjectName("x_predict_txt")
        self.x_predict_txt.setReadOnly(True)   # không cho user sửa
        self.y_aruco_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.y_aruco_txt.setGeometry(QtCore.QRect(730, 360, 50, 20))
        self.y_aruco_txt.setObjectName("y_aruco_txt")
        self.y_aruco_txt.setReadOnly(True)   # không cho user sửa
        self.y_predict_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.y_predict_txt.setGeometry(QtCore.QRect(930, 360, 50, 20))
        self.y_predict_txt.setObjectName("y_predict_txt")
        self.y_predict_txt.setReadOnly(True)   # không cho user sửa
        self.yaw_aruco_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.yaw_aruco_txt.setGeometry(QtCore.QRect(730, 390, 50, 20))
        self.yaw_aruco_txt.setObjectName("yaw_aruco_txt")
        self.yaw_aruco_txt.setReadOnly(True)   # không cho user sửa
        self.yaw_predict_txt = QtWidgets.QLineEdit(self.centralwidget)
        self.yaw_predict_txt.setGeometry(QtCore.QRect(930, 390, 50, 20))
        self.yaw_predict_txt.setObjectName("yaw_predict_txt")
        self.yaw_predict_txt.setReadOnly(True)   # không cho user sửas
        ...
        self.plot_widget = FigureCanvas(plt.Figure(figsize=(3, 3)))  # Biểu đồ 1
        self.plot_widget_1 = FigureCanvas(plt.Figure(figsize=(3, 3)))  # Biểu đồ 2
        self.plot_widget_2 = FigureCanvas(plt.Figure(figsize=(3, 3)))  # Biểu đồ 3
        self.plot_widget_3 = FigureCanvas(plt.Figure(figsize=(3, 3)))  # Biểu đồ 4
        ...
        self.plot_widget.setGeometry(QtCore.QRect(10, 490, 240, 240))
        self.plot_widget_1.setGeometry(QtCore.QRect(265, 490, 240, 240))    
        self.plot_widget_2.setGeometry(QtCore.QRect(520, 490, 240, 240))
        self.plot_widget_3.setGeometry(QtCore.QRect(775, 490, 240, 240))

        # Cấu hình trục
        self.ax1 = self.plot_widget.figure.add_subplot(111)
        self.ax1.set_xlabel("x (cm)", fontsize=8, labelpad=4)  # labelpad tăng khoảng cách để không bị che
        self.ax1.set_ylabel("y (cm)", fontsize=8, labelpad=3)

        self.ax2 = self.plot_widget_1.figure.add_subplot(111)
        self.ax2.set_xlabel("Time (s)", fontsize=8, labelpad=4)
        self.ax2.set_ylabel("error x (cm)", fontsize=8, labelpad=3)

        self.ax3 = self.plot_widget_2.figure.add_subplot(111)
        self.ax3.set_xlabel("Time (s)", fontsize=8, labelpad=4)
        self.ax3.set_ylabel("error y (cm)", fontsize=8, labelpad=3)

        self.ax4 = self.plot_widget_3.figure.add_subplot(111)
        self.ax4.set_xlabel("Time (s)", fontsize=8, labelpad=4)
        self.ax4.set_ylabel("error yaw (degree)", fontsize=8, labelpad=3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Aruco_Pose.setText(_translate("MainWindow", "Aruco_Pose"))
