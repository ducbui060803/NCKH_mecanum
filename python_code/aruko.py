...
# ---------------------------- ArUco ----------------------------
aruco_dict = aruco.getPredefinedDictionary(aruco.DICT_4X4_50) # Lấy dữ liệu từ thư viên aruco
parameters = aruco.DetectorParameters()                       # Lấy dữ liệu từ thư viên aruco
...
while True:
    ...
    # --- Read corner and id of marker detected in frame ---
